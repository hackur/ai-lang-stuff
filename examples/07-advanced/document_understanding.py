...
class DocumentUnderstandingAgent:
    ...
    def __init__(
        ...
        logger.info(f"Initialized DocumentUnderstandingAgent with models: {text_model}, {vision_model}")
    ...
    def analyze_structure(self, pages: List[Dict]) -> Dict:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ...
            ("human", """Analyze the structure of this document:
...
Title:""")
    ...
    def answer_question(self, pages: List[Dict], question: str) -> str:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", """You answer questions about documents accurately.
...
def main():
    ...
    parser.add_argument(
        "document",
        help="Path to document (PDF or text file)"
    )
    parser.add_argument(
        "--question", "-q",
